...
export function SupplierOrderForm({ orderId, initialOrder, permissions }: Props) {
  ...
  async function save(submit: boolean) {
    ...
    try {
      ...
      if (!submit) { router.push('/supplier-orders'); return; }
