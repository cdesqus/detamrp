...
export function SupplierOrderIndex({ permissions }: Props = {}) {
  ...
  return <section className="module-index supplier-order-index">
    ...
    <div className="table-frame"><table><thead><tr><th>PO Number</th><th>Supplier</th><th>Order Date</th><th>Expected Date</th><th>Status</th>{canViewPrices && <th>Total</th>}<th>PO PDF</th><th>DN PDF</th><th>Kanban Labels</th><th>Sage No.</th><th>Created By</th><th>Action</th></tr></thead><tbody>
