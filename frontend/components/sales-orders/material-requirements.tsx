...
export function MaterialRequirements({ result, showCosts = false }: { result:RequirementResult; showCosts?:boolean }) {
 ...
 return <div className="module-index">
  ...
  <div className="page-title-row"><div><h2>Material Summary</h2><p className="muted">Terminal materials only. Purchase Kanban is a rounded suggestion, not a change to required quantity.</p></div></div>
