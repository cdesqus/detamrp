  ...
  return (
    <article className="dashboard-panel">
      ...
      <div className={`chart-stage chart-${variant}`}>
        {empty ? <div className="chart-empty"><span className="chart-empty-mark" aria-hidden="true" /><strong>No transaction data yet</strong><span>The chart will populate automatically from operational activity.</span></div> : children}
      </div>
    </article>
  );
}
